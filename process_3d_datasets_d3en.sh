...
do
  ...
  do
    ...
    python generate-sassie-ecco-netcdfs-s3.py --root_filenames $x --root_s3_name s3://ecco-model-granules/SASSIE/N1/ --root_dest_s3_name s3://ecco-processed-data/SASSIE/N1/V1/HH/NETCDF/ --files_to_process $sn $en  -l /data${disk} --push_to_s3 > ${fsn}_${fen}.log &
