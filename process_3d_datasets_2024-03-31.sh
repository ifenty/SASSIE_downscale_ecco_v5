...
#declare -a arr=("KPP_hbl_day_mean", tr_adv_x_3D_day_mean")
declare -a arr=("tr_adv_x_3D_day_mean")
...
do
  ...
  do
    ...
    cmd="python generate-sassie-ecco-netcdfs-s3.py  --root_filenames $x  --root_s3_name s3://ecco-model-granules/SASSIE/N1/  --root_dest_s3_name ${es3}   --files_to_process $sn $en  -l /nvme_data${disk}  --keep_local_files --push_to_s3  --save_nc_to_disk 1> ${x}_${fsn}_${fen}.log 2> ${x}_${fsn}_${fen}.err.log &"
    echo $cmd
    eval $cmd
